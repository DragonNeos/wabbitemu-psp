...
#define ERR_MISSING_CHECKSUM ERR_FILE_NO_EXIST - 1
#define ERR_MISSING_LENGTH ERR_MISSING_CHECKSUM - 1
#define ERR_MISSING_ADDRESS ERR_MISSING_LENGTH - 1
#define ERR_MISSING_DATA ERR_MISSING_ADDRESS - 1
#define ERR_MISSING_SIZE ERR_MISSING_DATA - 1
#define ERR_MISSING_TYPE ERR_MISSING_SIZE - 1
#define ERR_ALLOC_FAILED ERR_MISSING_TYPE - 1
